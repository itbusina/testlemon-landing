...
addBanner('banner', config.bannerHealine, config.bannerMessage, config.bannerButtonText, config.bannerLink);
...
addCta('cta', config.ctaHeadline, config.ctaMessage, config.ctaButtonText, config.ctaButtonLink);
