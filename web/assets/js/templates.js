...
export function addCookieConsent(selector = 'gdpr', trackingID, privacyUrl) {
  let html = `
    <div id="gdpr-banner" style="display: none;" class="text-xs fixed bottom-8 left-4 z-[999] inline-flex items-center gap-[10px] rounded-lg bg-white px-[14px] py-2 shadow-2 dark:bg-dark-2 sm:left-9">
        <span class="font-medium text-dark-3 dark:text-dark-6">This website uses cookies.
          <a href="${privacyUrl}" style="text-decoration: underline;"> Learn more</a>
        </span>
          ...
          <div class="mb-10 w-full">
            ...
            <div class="-mx-3 flex items-center">
              <a href="https://www.linkedin.com/company/itbusina/" class="px-3 text-gray-7 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="fill-current" viewBox="0 0 256 256">
                  <path
                    d="M216,24H40A16,16,0,0,0,24,40V216a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V40A16,16,0,0,0,216,24Zm0,192H40V40H216V216ZM96,112v64a8,8,0,0,1-16,0V112a8,8,0,0,1,16,0Zm88,28v36a8,8,0,0,1-16,0V140a20,20,0,0,0-40,0v36a8,8,0,0,1-16,0V112a8,8,0,0,1,15.79-1.78A36,36,0,0,1,184,140ZM100,84A12,12,0,1,1,88,72,12,12,0,0,1,100,84Z">
                  </path>
                </svg>
              </a>
              <a href="https://www.facebook.com/itbusina/" class="px-3 text-gray-7 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="fill-current" viewBox="0 0 256 256"><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm8,191.63V152h24a8,8,0,0,0,0-16H136V112a16,16,0,0,1,16-16h16a8,8,0,0,0,0-16H152a32,32,0,0,0-32,32v24H96a8,8,0,0,0,0,16h24v63.63a88,88,0,1,1,16,0Z"></path></svg>
              </a>
              <a href="https://x.com/itbusina/" class="px-3 text-gray-7 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="fill-current" viewBox="0 0 256 256">
                  <path
