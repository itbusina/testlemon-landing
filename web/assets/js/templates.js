      ...
      <div class="-mx-4 flex flex-wrap items-center">
        ...
        <div class="w-full px-4">
          <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
            <div class="mt-16">
              <video width="2000" autoplay muted loop controls poster="assets/images/hero/hero-image-white.png" class="dark:hidden mx-auto max-w-full rounded-t-xl rounded-tr-xl">
              ...
              <video width="2000" autoplay muted loop controls poster="assets/images/hero/hero-image-black.png" class="hidden dark:block mx-auto max-w-full rounded-t-xl rounded-tr-xl">
